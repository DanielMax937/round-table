Generate architecture and failure-mode diagrams for this PR.
...
low: 0
        ...
        - A short explanation of the affected flow.
        - At least one Mermaid flowchart.
        - Optional Mermaid sequence diagram if request/async flow matters.
        - A "Failure Modes" section showing where assumptions can break.

        Use fenced mermaid blocks. Do not invent modules not implied by the diff.
