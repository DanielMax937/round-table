    ...
    [
      {
        ...
        content: [
          ...
          'Prefer one continuous shot with explicit time beats over broad story summary. If multiple shots are requested, decompose them as independent shot segments with clean cut points and stable identity anchors.',
          'If a reference image is attached, treat it as a first-frame visual anchor and preserve its composition, character identity, wardrobe, prop placement, room layout, and color temperature.',
      ...
      },
      {
        ...
        content: [
          ...
          '',
          'Prompt requirements:',
          '- FORMAT: define duration, aspect ratio, one continuous shot by default, no trailer, no montage, no subtitles, no dialogue lip-sync unless explicitly unavoidable.',
          '- FIRST-FRAME ANCHOR: state what must be preserved from the reference image or visual design prompt: composition, face, hair, wardrobe, prop placement, spatial geography, and color temperature.',
          '- CAMERA PATH: define shot size, camera height, lens feel, stabilization, speed, and one motivated movement only; avoid impossible camera jumps.',
          '- SUBJECT MOTION: define small readable actions, eyelines, body weight shifts, facial micro-expression changes, and simple hand/object interaction.',
          '- TIME BEATS: break motion into exact beats such as 0-2s, 2-5s, 5-8s; each beat should change either camera position, actor intention, or object state, not all at once.',
          '- CONTINUITY LOCKS: explicitly keep identity, wardrobe, room layout, foreground/midground/background, light source, and screen direction stable across the whole clip.',
          ...
          '- For multi-shot requests, list SHOT 1, SHOT 2, SHOT 3 with clean cut or match-cut logic; preserve character and environment constraints between shots.',
          '- NEGATIVE CONSTRAINTS: no morphing faces, no extra limbs, no fused hands, no floating props, no random text, no fake UI, no logos, no poster lighting, no generic inspirational mood, no sudden scene change.',
        ].filter(Boolean).join('\n\n'),
      },
    ],
